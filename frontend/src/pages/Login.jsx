    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-950 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-dark-400">Log in to access Venam AI.</p>
        </div>
        ...
        <div className="glass-card border border-white/5 rounded-3xl p-8 shadow-2xl relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="/forgot-password" className="text-xs text-brand-400 hover:text-brand-300 transition-colors link-lift">Forgot password?</Link>
              </div>
          ...
          <p className="text-center text-dark-400 mt-8 text-sm">
            ...
            <Link to="/signup" className="text-white hover:text-brand-400 font-medium transition-colors link-lift">
              Sign up
            </Link>
          </p>
        </div>
